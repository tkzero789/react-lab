...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar rounded-xl bg-background p-3 [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-gray-950 border-gray-200 shadow-2xs relative rounded-md border dark:has-focus:border-gray-300 dark:border-gray-800 ",
        ...
        range_end: cn(
          "bg-gray-100 rounded-r-md dark:bg-gray-800",
