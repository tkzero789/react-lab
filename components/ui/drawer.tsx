...
function Drawer({
  ...
  const contextValue = React.useMemo(
    ...
    [hasSnapPoints, snapHeight, modal, showSwipeHandle, swipeDirection]
  )
...
function DrawerContent({
  ...
  const { hasSnapPoints, snapHeight, modal, showSwipeHandle, swipeDirection } =
    useDrawer()
  const swipeAxis =
        ...
        >
          ...
          >
            ...
            <DrawerPrimitive.Content
              ...
              className={cn(
                "flex min-h-0 flex-1 flex-col overflow-hidden overscroll-contain rounded-[inherit] transition-opacity duration-300 ease-[cubic-bezier(0.45,1.005,0,1.005)] select-text group-data-nested-drawer-open/drawer-popup:opacity-0 group-data-nested-drawer-swiping/drawer-popup:opacity-100 group-data-swiping/drawer-popup:select-none group-data-[swipe-direction=down]/drawer-popup:pb-[env(safe-area-inset-bottom)]"
              )}
            >
              {children}
            </DrawerPrimitive.Content>
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-0.5 border-b p-4 group-data-[swipe-axis=y]/drawer-popup:text-center md:text-left",
        className
      )}
      {...props}
    />
