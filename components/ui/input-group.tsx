...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group shadow-2xs relative flex w-full items-center rounded-xl border bg-input outline-hidden transition-[color,box-shadow]",
...
const inputGroupButtonVariants = cva(
  "flex items-center gap-2 text-sm shadow-none rounded-xl",
  {
    variants: {
      size: {
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 border-0 bg-transparent shadow-none placeholder:text-muted-foreground focus-visible:ring-0 dark:bg-transparent",
        className,
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        "flex-1 resize-none rounded-none border-0 bg-transparent py-3 shadow-none focus-visible:ring-1 dark:bg-transparent",
        className,
      )}
      {...props}
    />
